...
<div class="col-lg-4 m-auto pt-5 ">
	<br><br><div class="container">
	  <h2 class="text_cnter bg-primary text-white text-center p-2">Register</h2>
		<div class="col-6-lg">
		  ...
		  <?php include('errors.php'); ?>
			<div class="input-group mt-5 mb-3">
				...
				<input type="text" class="form-control" placeholder=" Enter Usename"  name="username" value="<?php echo $username; ?>"  required>
			</div>
			...
			<div class="input-group mb-3">
				...
				<input type="password" class="form-control" placeholder=" Enter password"  name="password_2" required>
			</div>
				<div class="button w-100 pb-5 pt-4" style="display:flex; ">
					<button type="Submit" class="btn btn-success ml-1 w-50 bg-primary"  name="reg_user">login</button>
